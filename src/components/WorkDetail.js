                ...
                <section className="container py-5">
                    ...
                    <div className="row justify-content-center pb-4">
                        <div className="col-lg-8">
                            <div id="templatemo-slide-link-target" className="card mb-3">
                                <img className="img-fluid border rounded" src="./img/work-slide-04.jpg" alt="Card image cap" />
                            </div>
                                ...
                                <div id="multi-item-example" className="col-10 carousel slide" data-bs-ride="carousel">
                                    <div className="carousel-inner" role="listbox">
                                        <div className="carousel-item active">
                                            <div className="row">
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-06.jpg">
                                                        <img className="img-fluid border rounded" src="./img/work-slide-06-small.jpg" alt="Product Image" />
                                                    </a>
                                                </div>
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-05.jpg">
                                                        <img className="img-fluid border rounded" src="./img/work-slide-05-small.jpg" alt="Product Image" />
                                                    </a>
                                                </div>
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-04.jpg">
                                                        <img className="img-fluid border rounded" src="./img/work-slide-04-small.jpg" alt="Product Image" />
                                                    </a>
                                                </div>
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-03.jpg">
                                                        <img className="img-fluid border rounded" src="./img/work-slide-03-small.jpg" alt="Product Image" />
                                                    </a>
                                                </div>
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-01.jpg">
                                                        <img className="img-fluid border rounded" src="./img/work-slide-01-small.jpg" alt="Product Image" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="carousel-item">
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-02.jpg">
                                                        <img className="img-fluid border rounded" src="./img/work-slide-02-small.jpg" alt="Product Image" />
                                                    </a>
                                                </div>
                                                <div className="col">
                                                    <a className="templatemo-slide-link" href="./img/work-slide-01.jpg">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8 pt-4 pb-4">
                            <div className="ratio ratio-16x9">
                                <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/1z--ZRS5x5U" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                    ...
                    <div className="row pb-4">
                        <div className="worksingle-comment-body col-md-8 m-auto">
                            <div className="d-flex">
                                <div>
                                    <img className="rounded-circle" src="./img/team-05.jpg" style={{ width: '50px' }} />
                                </div>
                    ...
                    <div className="row pb-4">
                        <div className="col-lg-8 m-auto">
                            <div className="d-flex">
                                <div>
                                    <img className="rounded-circle" src="./img/team-01.jpg" style={{ width: '50px' }} /> 
                                </div>
                                <div className="comment-body">
                                    <div className="comment-header d-flex justify-content-between ms-3">
                                        <div className="header text-start">
                                ...
                                <div className="row gx-5">
                                    <div className="col-sm-6 col-lg-4 mb-5">
                                        <a href="#" className="related-content card text-decoration-none overflow-hidden h-100">
                                            <img className="related-img card-img-top" src="./img/related-post-01.jpg" alt="Card image cap" />
                                    ...
                                    <div className="col-sm-6 col-lg-4 mb-5">
                                        <a href="#" className="related-content card text-decoration-none overflow-hidden h-100">
                                            <img className="related-img card-img-top" src="./img/related-post-02.jpg" alt="Card image cap" />
                                            <div className="related-body card-body p-4">
                                    ...
                                    <div className="col-sm-6 col-lg-4 mb-5">
                                        <a href="#" className="related-content card text-decoration-none overflow-hidden h-100">
                                            <img className="related-img card-img-top" src="./img/related-post-03.jpg" alt="Card image cap" />
                                            <div className="related-body card-body p-4">
                                                <h5 className="card-title h6 m-0 semi-bold-600 text-dark">Digital Marketing</h5>
                                                <p className="card-text pt-2 mb-1 light-300 text-dark">
