            ...
            <nav id="main_nav" className="navbar navbar-expand-lg navbar-light bg-white shadow">
                    <div className="container d-flex justify-content-between align-items-center">
                        <Link className="navbar-brand h1" to="/">
                            ...
                            <span className="text-dark h4">Exhorn</span> <span className="text-primary h4">.Com</span>
                        </Link>
                        ...
                        <div className="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                            ...
                            <div className="navbar align-self-center d-flex">
                                <a className="nav-link" to="#"><i className='bx bx-bell bx-sm bx-tada-hover text-primary'></i></a>
                                <a className="nav-link" to="#"><i className='bx bx-cog bx-sm text-primary'></i></a>
                                <a className="nav-link" to="#"><i className='bx bx-user-circle bx-sm text-primary'></i></a>
                            </div>
                        </div>
                    </div>
                </nav>
